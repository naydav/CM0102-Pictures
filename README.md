...
*Already have CM0102 with Nick's patcher (1280x800)? Simply copy the Pictures folder.*

1. *(Optional)* Back up your current **Pictures/** folder so you can restore it later if needed
2. Install **CM0102** from scratch
3. Apply the official **3.9.68** patch
4. Copy the **December 2025 Data Update** into your CM0102 **Data/** directory
5. Run **Nick's CM0102Patcher** and enable **1280x800 resolution** — [Full patcher guide](https://champman0102.net/viewtopic.php?t=1943)
6. **Copy the Pictures/ folder** from this pack into your CM0102 game root directory
